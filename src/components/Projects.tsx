...
const PROJECTS: ProjectData[] = [
  ...
  },
  {
    ...
    desc:     "An automated aerial object detection and airspace monitoring system using AI and IoT ultrasonic sensors to detect drones and aerial objects in restricted areas with real-time alerts. Presented as a research paper that won 2nd prize.",
    features: [
      "Automated drone & aerial object detection",
