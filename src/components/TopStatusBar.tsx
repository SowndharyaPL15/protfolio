...
export default function TopStatusBar({ mobileOpen, setMobileOpen }: TopStatusBarProps) {
  ...
  return (
    ...
    >
      ...
      {/* METRICS ROW (Hidden on mobile for space, scrolls horizontally or visible on desktop) */}
      <div className="hidden lg:flex flex-1 items-center gap-4 h-full pl-2">
        {/* Status */}
        <div className="flex flex-col justify-center h-full border-r pr-4" style={{ borderColor: "var(--border-subtle)" }}>
          <span className="text-[10px] font-space tracking-widest text-gray-500 mb-1">STATUS</span>
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-medium" style={{ color: "var(--accent-primary)" }}>Available for Opportunities</span>
          </div>
        </div>

        {/* Projects */}
        <div className="flex flex-col justify-center h-full border-r pr-4 pl-2" style={{ borderColor: "var(--border-subtle)" }}>
          <span className="text-[10px] font-space tracking-widest text-gray-500 mb-1 flex items-center gap-1">
            <svg className="w-3 h-3 text-[var(--accent-primary)]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2m0 10a2 2 0 002 2h2a2 2 0 002-2M9 7a2 2 0 012-2h2a2 2 0 012 2m0 10V7m0 10a2 2 0 002 2h2a2 2 0 002-2V7a2 2 0 00-2-2h-2a2 2 0 00-2 2" /></svg>
            PROJECTS
          </span>
          <div className="flex items-center gap-1">
            <span className="text-sm font-bold text-[var(--text-main)]">8</span>
        ...
        <div className="flex flex-col justify-center h-full border-r pr-4 pl-2" style={{ borderColor: "var(--border-subtle)" }}>
          ...
          <div className="flex items-center gap-1">
            <span className="text-sm font-bold text-[var(--text-main)]">8.35</span>
            <span className="text-[10px] text-[var(--text-muted)]">SEM-6</span>
          </div>
        </div>
