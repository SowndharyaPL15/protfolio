...
const KB = {
  ...
  projects:
    "1. **CuraNet – Caregiver Support System** (HTML, CSS, JS, PostgreSQL)\n2. **PharmaTrace AI – Medicine Authentication** (Node.js, Express, PostgreSQL, Python, Flask, OpenCV)\n3. **SmartExpensePro – SMS Expense Tracker** (Android, Java, SMS API, SQLite, MPAndroidChart)\n4. **Aerial Object Detection – IoT Based** (Arduino, Embedded Systems, IoT, C, C++)\n5. **CivicPulse – Smart Civic Issue Management** (PHP, MySQL, JavaScript, Bootstrap)\n6. **Connectify – Real-Time Chat Application** (Laravel, PHP, MySQL, JavaScript, WebSockets)\n7. **ModelHubX – MLOps Registry & Deployment** (FastAPI, Kubernetes, Redis, Docker, Next.js)\n8. **AI Product Authentication System** (Python, PyTorch, OpenCV, CNN, React)\n9. **Clixora – URL Shortener & Analytics** (React, Node.js, Express, PostgreSQL)\n10. **INDUS AI – Industrial Cognitive Memory System** (FastAPI, React, PostgreSQL, FAISS, LangChain, Python)",
  education:
